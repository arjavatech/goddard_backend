...
CREATE TABLE `admission_form` (
  ...
  `do_relevant_custody_papers_apply` tinyint(1) DEFAULT NULL,
  `gender` varchar(10) DEFAULT NULL,
  `special_diabilities` text,
  `allergies_medication_reaction` tinyint(1) DEFAULT NULL,
  ...
  `agree_all_above_information_is_correct` tinyint(1) DEFAULT NULL,
  ...
  `family_history_allergies` tinyint(1) DEFAULT NULL,
  `family_history_heart_problems` tinyint(1) DEFAULT NULL,
  `family_history_tuberculosis` tinyint(1) DEFAULT NULL,
  `family_history_asthma` tinyint(1) DEFAULT NULL,
  `family_history_high_blood_pressure` tinyint(1) DEFAULT NULL,
  `family_history_vision_problems` tinyint(1) DEFAULT NULL,
  `family_history_diabetes` tinyint(1) DEFAULT NULL,
  `family_history_hyperactivity` tinyint(1) DEFAULT NULL,
  `family_history_epilepsy` tinyint(1) DEFAULT NULL,
  `no_illnesses_for_this_child` tinyint(1) DEFAULT NULL,
  ...
  `last_five_years_moved` tinyint(1) DEFAULT NULL,
  ...
  `changes_at_home_situation` tinyint(1) DEFAULT NULL,
  `educational_expectations_of_child` text,
  `fam_his_instructions` tinyint(1) DEFAULT NULL,
  `do_you_agree_this_immunization_instructions` tinyint(1) DEFAULT NULL,
  `important_fam_members` varchar(100) DEFAULT NULL,
  `about_family_celebrations` varchar(100) DEFAULT NULL,
  `childcare_before` tinyint(1) DEFAULT NULL,
  ...
  `restricted_diet` tinyint(1) DEFAULT NULL,
  `restricted_diet_reason` text,
  `eat_own` tinyint(1) DEFAULT NULL,
  `eat_own_reason` text,
  `favorite_foods` text,
  `rest_in_the_middle_day` tinyint(1) DEFAULT NULL,
  `reason_for_rest_in_the_middle_day` text,
  `rest_routine` text,
  `toilet_trained` tinyint(1) DEFAULT NULL,
  `reason_for_toilet_trained` text,
  `explain_for_existing_illness_allergy` tinyint(1) DEFAULT NULL,
  `existing_illness_allergy` text,
  `functioning_at_age` tinyint(1) DEFAULT NULL,
  `explain_for_functioning_at_age` text,
  `explain_for_able_to_walk` tinyint(1) DEFAULT NULL,
  `able_to_walk` text,
  `explain_for_communicate_their_needs` tinyint(1) DEFAULT NULL,
  `communicate_their_needs` text,
  `any_medication` tinyint(1) DEFAULT NULL,
  `explain_for_any_medication` text,
  `utilize_special_equipment` tinyint(1) DEFAULT NULL,
  `explain_for_utilize_special_equipment` text,
  `significant_periods` tinyint(1) DEFAULT NULL,
  `explain_for_significant_periods` text,
  `desire_any_accommodations` tinyint(1) DEFAULT NULL,
  `explain_for_desire_any_accommodations` text,
  `additional_information` text,
  `do_you_agree_this` tinyint(1) DEFAULT NULL,
  `child_password_pick_up_password_form` varchar(100) DEFAULT NULL,
  `do_you_agree_this_pick_up_password_form` tinyint(1) DEFAULT NULL,
  `photo_usage_photo_video_permission_form` text,
  `photo_permission_agree_group_photos_electronic` tinyint(1) DEFAULT NULL,
  `do_you_agree_this_photo_video_permission_form` tinyint(1) DEFAULT NULL,
  `security_release_policy_form` tinyint(1) DEFAULT NULL,
  `med_technicians_med_transportation_waiver` text,
  `medical_transportation_waiver` tinyint(1) DEFAULT NULL,
  `do_you_agree_this_health_policies` tinyint(1) DEFAULT NULL,
  `parent_sign_outside_waiver` tinyint(1) DEFAULT NULL,
  `approve_social_media_post` tinyint(1) DEFAULT NULL,
  `printed_name_social_media_post` varchar(100) DEFAULT NULL,
  `do_you_agree_this_social_media_post` tinyint(1) DEFAULT NULL,
  ...
  `agree_all_above_info_is_correct` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`child_id`),
...
CHANGE `enrollment_name` `child_first_name` VARCHAR(255);
